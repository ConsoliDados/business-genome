...
Pre-project, cross-cutting. Lives outside `11-projects/`.

- `leads/` — pre-sale leads. Qualify with the [[qualify-lead]] skill; create with
  `96-templates/tp-lead.md`.
- `accounts/` — client companies. **One account → many projects.** Create with
  `96-templates/tp-account.md`.

A lead that converts → [[kickoff]] creates the project under `11-projects/clients/`; the project
