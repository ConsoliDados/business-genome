...
> **Pipeline-aware / create-if-missing:** start from a model in `_templates/contracts/<lang>/`
...
**Writes:** `…/commercial/contract.md` (instance) · models live in `_templates/contracts/<lang>/`
