...
> **Pipeline-aware / create-if-missing:** start from the model `_templates/proposals/<lang>/project-proposal.md`.
...
**Writes:** `…/commercial/proposal.md` (instance) · model lives in `_templates/proposals/<lang>/`
